...
/**
 * https://stackoverflow.com/questions/5781314/getting-a-device-udid-from-mobileconfig
 */
...
header("Location: https://testdrive.sironaecg.com/wp-content/plugins/testdrive/enroll.php?params={$params}", true, 301);
?>
